...
const GateControlModal = ({ onClose, userRole }) => {
  ...
  const gates = [
    { id: "GATE-001", name: "North Gate", status: "open" },
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 id="gate-control-title" className="text-xl font-semibold text-gray-900">
        ...
        <div className="p-6">
          {!canControlGates ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">You need administrator or operator privileges to control gates.</p>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {gates.map((gate) => (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(gate.status)}`}
                      >
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        disabled={gate.status === "open" || gate.status === "maintenance" || showConfirmation}
                      ...
                      <button
                        ...
                        disabled={gate.status === "closed" || gate.status === "maintenance" || showConfirmation}
              ...
              <div className="mt-8 p-6 bg-red-50 border border-red-200 rounded-lg">
                <h3 className="text-lg font-medium text-red-900 mb-2">Emergency Actions</h3>
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex justify-end space-x-4">
                <button onClick={cancelAction} disabled={isProcessing} className="btn-secondary disabled:opacity-50">
                  Cancel
                </button>
                <button
